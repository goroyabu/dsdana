...
CoupleHitText::CoupleHitText() : ANLModuleBase("CoupleHitText", "2.0"), mDatabase(nullptr),
			 m_spect(nullptr), m_image(nullptr)
{
    m_delta_e_threshold = 5.0;
}
void CoupleHitText::mod_init(int &status)
{
    using namespace evs;
    status = ANL_OK;
    //std::cout << "CoupleHitText::mod_init" << std::endl;
...
void CoupleHitText::mod_his(int &status)
{
...
void CoupleHitText::mod_com(int &status)
{
    status = ANL_OK;
}
void CoupleHitText::mod_ana(int &status)
{
    status = ANL_OK;
...
void CoupleHitText::mod_endrun(int &status)
{
...
void CoupleHitText::mod_exit(int &status)
{
    status = ANL_OK;
}
int CoupleHitText::bnkDefAll()
{
    using namespace std;
    using namespace bnk;
...
int CoupleHitText::clearVectorAll()
{
    m_nhit_lv3 = 0;
    m_detid_lv3.clear();
    m_epi_lv3.clear();
...
int CoupleHitText::reconstructLv2toLv3(int detid)
{
...
void CoupleHitText::extractOneDetector(int detid)
{
    m_nsignal_x = 0;
    m_epi_x.clear();
    m_pos_x.clear();
...
void CoupleHitText::sortIndex(int nsignal, std::vector<float> &epi_list, std::vector<int>* sorted_list)
{
...
/*
void CoupleHitText::case1and1(int detid)
{
...
*/
int CoupleHitText::case1and1(int detid, const signal_data& x0, const signal_data& y0)
{
    // float pos_z, width_z;
    // mDatabase->GetZ(detid, 0, &pos_z);
    // mDatabase->GetWidthZ(detid, 0, &width_z);
...
int CoupleHitText::case1and2(int detid, const signal_data& x0, const signal_data& y0, const signal_data& y1)
{
    // float pos_z, width_z;
    // mDatabase->GetZ(detid, 0, &pos_z);
    // mDatabase->GetWidthZ(detid, 0, &width_z);
...
int CoupleHitText::case2and1(int detid, const signal_data& x0, const signal_data& x1, const signal_data& y0)
{
    // float pos_z, width_z;
    // mDatabase->GetZ(detid, 0, &pos_z);
    // mDatabase->GetWidthZ(detid, 0, &width_z);
...
int CoupleHitText::case2and2(int detid, const signal_data& x0, const signal_data& x1, const signal_data& y0, const signal_data& y1)
{
    // float pos_z, width_z;
    // mDatabase->GetZ(detid, 0, &pos_z);
    // mDatabase->GetWidthZ(detid, 0, &width_z);
...
int CoupleHitText::case3over(int detid, const std::vector<signal_data>& xsignal, std::vector<signal_data>& ysignal)
{
    //float pos_z, width_z;
    //mDatabase->GetZ(detid, 0, &pos_z);
    //mDatabase->GetWidthZ(detid, 0, &width_z);
...
/*
void CoupleHitText::case1and2(int detid)
{
    float pos_z, width_z;
    mDatabase->GetZ(detid, 0, &pos_z);
    mDatabase->GetWidthZ(detid, 0, &width_z);
...
void CoupleHitText::case2and1(int detid)
{
    float pos_z, width_z;
    mDatabase->GetZ(detid, 0, &pos_z);
    mDatabase->GetWidthZ(detid, 0, &width_z);
...
void CoupleHitText::case2and2(int detid)
{
    float pos_z, width_z;
    mDatabase->GetZ(detid, 0, &pos_z);
    mDatabase->GetWidthZ(detid, 0, &width_z);
...
void CoupleHitText::case3over(int detid)
{
    float pos_z, width_z;
    mDatabase->GetZ(detid, 0, &pos_z);
    mDatabase->GetWidthZ(detid, 0, &width_z);
