...
int WriteHittreeAll::set_write_branch()
{
    ...
    define_branch<unsigned short int>("gps1pps", "gps1pps/s");
    define_branch<unsigned short int>("ext1pps", "ext1pps/s");
    define_branch<unsigned int>("msec_counter", "msec_counter/i");
